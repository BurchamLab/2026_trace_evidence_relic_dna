...
XGBoost models were trained/tested using a custom conda environment built from the provided xgb_models_nobuilds.yml file.

If any questions, reach out to Dr. Zachary Burcham (zburcham@utk.edu).
